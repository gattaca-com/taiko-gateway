...
pub fn sign_fixed_k(prehash: B256, scalar: &NonZeroScalar) -> eyre::Result<Signature> {
    ...
    let sig = Signature::from_signature_and_parity(recoverable_sig, recovery_id.is_y_odd());
