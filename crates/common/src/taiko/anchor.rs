...
pub async fn compute_next_base_fee(
    ...
    let timestamp_elapsed = anchor.timestamp - parent.timestamp;
    ...
    let new_gas_target =
        base_fee_config.gasIssuancePerSecond as u64 * base_fee_config.adjustmentQuotient as u64;
    ...
    let base_fee = taiko_l2
        .calculateBaseFee(base_fee_config, timestamp_elapsed, parent_gas_excess, parent.gas_used)
        .call()
        .await?;
...
pub fn assemble_anchor_v2(
    ...
    let input =
        anchorV2Call::new((anchor.block_id, anchor.state_root, parent.gas_used, base_fee_config))
            .abi_encode();
